    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $tahun->id }}">Edit</button>
            ...
            <!-- Modal Edit -->
            <div class="modal fade" id="editModal{{ $tahun->id }}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('tahun-ajaran.update', $tahun->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" name="nama" value="{{ $tahun->nama }}" class="form-control" required>
                                
                                <label>Tanggal Mulai</label>
                                <input type="date" name="tanggal_mulai" value="{{ $tahun->tanggal_mulai }}" class="form-control" required>
                                
                                <label>Tanggal Selesai</label>
                                <input type="date" name="tanggal_selesai" value="{{ $tahun->tanggal_selesai }}" class="form-control" required>
