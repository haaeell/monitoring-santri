        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" action="{{ route('guru.update', $guru->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="alamat" class="form-control form-control-sm" rows="5" required>{{ $guru->alamat }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
